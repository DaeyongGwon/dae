...
export default function Home() {
    ...
    return (
        <div>
            <img className="main-img" src="/developer.jpeg"></img>
            <div className="MainHeaderContent">
                ...
                <div className="title-sub">
                    ...
                    매우 꼼꼼한 성격, 그리고 공부를 밥 먹듯이 하는 습관이 저의 장점입니다. 안녕하세요 안녕하세요 안녕하세요
                </div>
            </div>
            ...
            <div className="archiving-mainBox">
                <div className="ArchivingContent">
                    ...
                    <div className="archiving-container">
                        <div className="archiving-box">
                            <a href="https://github.com/DaeyongGwon">
                        ...
                        <div className="archiving-box">
                            <a href="https://iffyong.tistory.com/">
                                <div className="archiving-img-box">
