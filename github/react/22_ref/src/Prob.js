    ...
    return (
        <>
            <form>
                ...
                <input ref={writerInputElem} id="writer" value={inputWriter} onChange={(e) => setInputWriter(e.target.value)} />
                <label htmlFor="title">제목: </label>
                <input ref={titleInputElem} id="title" value={inputTitle} onChange={(e) => setInputTitle(e.target.value)} />
